...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('gnuplot.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('gnuplot.wasm', import.meta.url).href;
}
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 382204;
